...
{ 
	...
	glBufferData(GL_ARRAY_BUFFER, 
		...
		nullptr,
		GL_STREAM_DRAW);
	// c. Enable vertex attribute 0. Create channel
...
void Skin::draw(const glm::mat4& viewProjMtx)
{
	...
	glm::mat4 model(1.0);
	// Color of the skin!!!!
	glm::vec3 color(1.00f, 0.75f, 0.0f);
	// Blood Orange glm::vec3 color(0.83f, 0.00f, 0.15f);
